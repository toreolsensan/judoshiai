...
gint official[NUM_CAT][10]  = {
    {0},
    {60000, 66000, 73000, 81000, 90000, 100000, 0},
    {55000, 60000, 66000, 73000, 81000, 90000, 0},
    {45000, 50000, 55000, 60000, 66000, 73000, 81000, 0},
    {34000, 38000, 42000, 46000, 50000, 55000, 60000, 66000, 0},
    {30000, 34000, 38000, 42000, 46000, 50000, 55000, 0},
    {27000, 30000, 34000, 38000, 42000, 46000, 50000, 55000, 0},
    {48000, 52000, 57000, 63000, 70000, 78000, 0},
    {48000, 52000, 57000, 63000, 70000, 0},
    {44000, 48000, 52000, 57000, 63000, 0},
    {32000, 36000, 40000, 44000, 48000, 52000, 57000, 63000, 0},
    {28000, 32000, 36000, 40000, 44000, 48000, 52000, 0},
    {25000, 28000, 32000, 36000, 40000, 44000, 48000, 52000, 0}
};

gchar *cat_names[NUM_CAT] = {
    "?", "M", "AP", "BP", "CP", "DP", "EP", "N", "AT", "BT", "CT", "DT", "ET"
};
...
guint french_size[4] = {8, 16, 32, 64};
