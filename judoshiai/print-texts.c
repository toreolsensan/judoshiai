...
gchar *print_texts[numprinttexts][NUM_LANGS] = {
    ...
    {"Kilpailijat C", "Tävlande C", "Competitors C", "Competidores C"},
    {"Kilpailijat D", "Tävlande D", "Competitors D", "Competidores D"},
    {"N:o", "Nr", "#", "Nº"},
    ...
    {"Ottelut B", "Matcherna B", "Matches B", "Combates B"},
    {"Ottelut C", "Matcherna C", "Matches C", "Combates C"},
    {"Ottelut D", "Matcherna D", "Matches D", "Combates D"},

    {"Ottelu", "Match", "Match", "Comb."},
    {"Sininen", "Blå", "Blue", "Azul"},
    {"Valkoinen", "Vit", "White", "Blanco"},
    {"Tulos", "Resultat", "Result", "Resultado"},
    {"Tulokset", "Resultat", "Results", "Clasificación"},
